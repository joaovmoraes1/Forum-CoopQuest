  ...
  try {
    ...
    const formattedTopic = {
      ...
      authorUser: {
        ...
        avatar: topic.authorUser.avatar || '/default-avatar.png', // Ajuste o caminho se necessário
      },
      replies: topic.replies.map(reply => ({
        ...
        authorUser: {
          ...
          avatar: reply.authorUser.avatar || '/default-avatar.png', // Ajuste o caminho se necessário
        },
      })),
    };
